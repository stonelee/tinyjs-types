...
declare namespace Tiny {
    ...
    function autoDetectRenderer(width: number, height: number, options?: Tiny.RendererOptions, forceCanvas?: boolean): Tiny.WebGLRenderer | Tiny.CanvasRenderer;
    function autoDetectRenderer(options?: Tiny.RendererOptions): Tiny.WebGLRenderer | Tiny.CanvasRenderer;
    ...
    class Container extends DisplayObject {
        ...
        */
        runSequenceAction(...actions: Action[])
       
        
        removeActions(): void;
        removeActionsTrace(): void;
    }
    class DisplayObject extends utils.EventEmitter implements interaction.InteractiveTarget, accessibility.AccessibleTarget {
        ...
        hitArea: Tiny.Rectangle | Tiny.Circle | Tiny.Ellipse | Tiny.Polygon | Tiny.RoundedRectangle | Tiny.HitArea;
        buttonMode: boolean;
        cursor: string;
        ...
        protected _mask: Tiny.Graphics | Tiny.Sprite;
        ...
        mask: Tiny.Graphics | Tiny.Sprite;
        ...
        setEventEnabled(b: boolean) // 设置是否可交互
  
        setPosition(x: number, y?: number)
        getPosition(): Point | ObservablePoint
        setPositionX(x: number)
        getPositionX(): number
        setPositionY(y: number)
        getPositionY(): number
        setPivot(x: number, y?: number)
        getPivot(): Point | ObservablePoint
        ...
        getScale(): Point | ObservablePoint
        setSkew(x: number, y?: number)
        getSkew(): ObservablePoint
        ...
        mouseout(event: interaction.InteractionEvent);
        mouseover(event: interaction.InteractionEvent);
        mouseup(event: interaction.InteractionEvent);
        mouseupoutside(event: interaction.InteractionEvent);
        pointercancel(event: interaction.InteractionEvent);
        pointerdown(event: interaction.InteractionEvent);
        pointermove(event: interaction.InteractionEvent);
        pointerout(event: interaction.InteractionEvent);
        pointerover(event: interaction.InteractionEvent);
        pointertap(event: interaction.InteractionEvent);
        pointerup(event: interaction.InteractionEvent);
        pointerupoutside(event: interaction.InteractionEvent);
        rightclick(event: interaction.InteractionEvent);
        rightdown(event: interaction.InteractionEvent);
        rightup(event: interaction.InteractionEvent);
        rightupoutside(event: interaction.InteractionEvent);
        tap(event: interaction.InteractionEvent);
        touchcancel(event: interaction.InteractionEvent);
        touchend(event: interaction.InteractionEvent);
        touchendoutside(event: interaction.InteractionEvent);
        touchmove(event: interaction.InteractionEvent);
        touchstart(event: interaction.InteractionEvent);
    }
    class TransformBase {
    ...
    class Graphics extends Container {
        ...
        protected _renderSpriteRect(renderer: Tiny.SystemRenderer): void;
    ...
    class GraphicsRenderer extends ObjectRenderer {
        constructor(renderer: Tiny.CanvasRenderer);
        ...
        destroy(): void;
        render(graphics: Graphics): void;
        protected updateGraphics(graphics: Tiny.Graphics): void;
    ...
    class Matrix {
        ...
        setTransform(x: number, y: number, pivotX: number, pivotY: number, scaleX: number, scaleY: number, rotation: number, skewX: number, skewY: number): Tiny.Matrix;
    ...
    interface ApplicationOptions extends RendererOptions {
        /**
         * `true` to use Tiny.ticker.shared, `false` to create new ticker. [default=false]
         */
        sharedTicker?: boolean;
  
        /**
         * `true` to use Tiny.loaders.shared, `false` to create new Loader.
         */
    ...
    class CanvasRenderer extends SystemRenderer {
        ...
        render(displayObject: Tiny.DisplayObject, renderTexture?: Tiny.RenderTexture, clear?: boolean, transform?: Tiny.Transform, skipUpdateTransform?: boolean): void;
    ...
    class SpriteRenderer extends ObjectRenderer {
        constructor(renderer: Tiny.WebGLRenderer);
    ...
    namespace interaction {
        ...
        class InteractionManager extends utils.EventEmitter {
            ...
            protected processPointerUp: (interactionEvent: InteractionEvent, displayObject: Container | Tiny.Sprite | Tiny.extras.TilingSprite, hit: boolean) => void;
            protected onPointerCancel: (event: PointerEvent) => void;
            protected processPointerCancel: (interactionEvent: InteractionEvent, displayObject: Tiny.Container | Tiny.Sprite | Tiny.extras.TilingSprite) => void;
            protected onPointerDown: (event: PointerEvent) => void;
            protected processPointerDown: (interactionEvent: InteractionEvent, displayObject: Tiny.Container | Tiny.Sprite | Tiny.extras.TilingSprite, hit: boolean) => void;
            protected onPointerMove: (event: PointerEvent) => void;
            protected processPointerMove: (interactionEvent: InteractionEvent, displayObject: Tiny.Container | Tiny.Sprite | Tiny.extras.TilingSprite, hit: boolean) => void;
            protected onPointerOut: (event: PointerEvent) => void;
            protected processPointerOverOut: (interactionEvent: InteractionEvent, displayObject: Tiny.Container | Tiny.Sprite | Tiny.extras.TilingSprite, hit: boolean) => void;
            ...
            protected processInteractive(
                ...
                displayObject: Tiny.Container | Tiny.Sprite | Tiny.extras.TilingSprite,
                func?: Function,
                hitTest?: boolean,
                interactive?: boolean
            ): boolean;
    ...
    namespace loaders {
        ...
        interface ResourceDictionary {
            [index: string]: Tiny.loaders.Resource;
        }
    ...
    namespace particles {
        ...
        interface ParticleRendererProperty {
            attribute: number;
            size: number;
            uploadFunction(children: Tiny.DisplayObject[], startIndex: number, amount: number, array: number[], stride: number, offset: number): void;
            unsignedByte: any;
            offset: number;
        }
    ...
    namespace prepare {
        ...
        abstract class BasePrepare<UploadHookSource> {
            ...
            protected findMultipleBaseTextures(item: Tiny.DisplayObject, queue: any[]): boolean;
            protected findBaseTexture(item: Tiny.DisplayObject, queue: any[]): boolean;
            protected findTexture(item: Tiny.DisplayObject, queue: any[]): boolean;
            add(item: Tiny.DisplayObject | Tiny.Container | Tiny.BaseTexture | Tiny.Texture | Tiny.Graphics | Tiny.Text | any): this;
            destroy(): void;
        }
    ...
    namespace core {
         ...
         * @name AssetLoader
         * @memberof Tiny
         * @see Tiny.loaders.Loader
         * @throws {ReferenceError} The loader system was overhauled in pixi v3, please see the new Tiny.loaders.Loader class.
         * @deprecated since version 3.0.0
         */
         ...
         * @memberof Tiny
         * @see Tiny.particles.ParticleContainer
         ...
         * @class
         * @private
         * @name Tiny.TransformManual
         * @see Tiny.TransformBase
         * @deprecated since version 4.0.0
         */
         ...
         * @static
         * @constant
         * @name Tiny.TARGET_FPMS
         * @see Tiny.settings.TARGET_FPMS
         ...
         * @static
         * @constant
         * @name Tiny.FILTER_RESOLUTION
         * @see Tiny.settings.FILTER_RESOLUTION
         * @deprecated since version 4.2.0
         */
         ...
         * @static
         * @constant
         * @name Tiny.MIPMAP_TEXTURES
         * @see Tiny.settings.MIPMAP_TEXTURES
         * @deprecated since version 4.2.0
         */
         ...
         * @static
         * @constant
         * @name Tiny.SPRITE_BATCH_SIZE
         * @see Tiny.settings.SPRITE_BATCH_SIZE
         * @deprecated since version 4.2.0
         */
         ...
         * @static
         * @constant
         * @name Tiny.SPRITE_MAX_TEXTURES
         * @see Tiny.settings.SPRITE_MAX_TEXTURES
         * @deprecated since version 4.2.0
         */
         ...
         * @static
         * @constant
         * @name Tiny.RETINA_PREFIX
         * @see Tiny.settings.RETINA_PREFIX
         * @deprecated since version 4.2.0
         */
         ...
         * @static
         * @constant
         * @name Tiny.DEFAULT_RENDER_OPTIONS
         * @see Tiny.settings.RENDER_OPTIONS
         * @deprecated since version 4.2.0
         */
    ...
    namespace GroupD8 {
        /**
         * @name Tiny.GroupD8.isSwapWidthHeight
         * @see Tiny.GroupD8.isVertical
    ...
    namespace extras {
         ...
         * @class
         * @name MovieClip
         * @memberof Tiny.extras
         * @see Tiny.extras.AnimatedSprite
         * @deprecated since version 4.2.0
         */
        type MovieClip = extras.AnimatedSprite;
    ...
    namespace filters {
         ...
         * @class
         * @private
         * @name Tiny.filters.VoidFilter
         * @see Tiny.filters.AlphaFilter
